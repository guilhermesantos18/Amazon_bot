...
site = 'https://www.amazon.es/s?k=iphone+11'
lista_produtos = []
...
selecionar_idioma = navegador.find_element_by_xpath(
    '//*[@id="customer-preferences"]/div/div/form/div[1]/div[1]/div[2]/div/label/span').click()
...
produtos = site_html.findAll('div', attrs={
...
for produto in produtos:
    ...
    # Descomentar para nome produto específico
    # if 'Apple' in nome_produto[0:5]:
    if produto.find('span', attrs={'class': 'a-price-whole'}):
        ...
        if produto.find('span', attrs={'class': 'a-price a-text-price'}):
            ...
            lista_produtos.append(
                [nome_produto, preco_do_produto, preco_do_produto_com_desconto + ' €', avaliacoes, link_produto])
    else:
        continue

# Criar a tabela
amazon_data = pd.DataFrame(lista_produtos,
                           columns=['Nome do produto', 'Preço do produto', 'Preço do produto com desconto',
                                    'Avaliações', 'Link do Produto'])
